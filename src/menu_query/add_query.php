...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO report(name_report,report_query,filter_query,filter_date_status,delete_status) VALUES('".$nama_query."','".$query_utama."','".$query_filter."','".$filter_status."',0)";
